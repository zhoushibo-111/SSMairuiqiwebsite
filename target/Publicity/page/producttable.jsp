            ...
            <div class="table-responsive">
                <table class="table table-hover" border="1px" style="text-align: center; margin: 0 auto;">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="${ctx}/product/findbyid?id=${obj.value.id}">修改</a>
                            <a href="${ctx}/product/delProduct?id=${obj.value.id}" onclick="del()">删除</a>
                        </td>

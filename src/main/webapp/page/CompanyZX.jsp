                    ...
                    <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul aria-labelledby="languages" class="dropdown-menu">
                                <li>
                                    <a rel="nofollow" href="#" class="dropdown-item"> <img src="behindPage/img/flags/16/DE.png" alt="English" class="mr-2">German</a>
                                </li>
                                <li>
                                    <a rel="nofollow" href="#" class="dropdown-item"> <img src="behindPage/img/flags/16/FR.png" alt="English" class="mr-2">French </a>
                                </li>
                            </ul>
                        </li>
                        <!-- Logout    -->
    ...
    <div class="page-content d-flex align-items-stretch">
        ...
        <nav class="side-navbar">
            ...
            <ul class="list-unstyled">
                ...
                <li class="active">
                    <a href="${ctx}/message/find"> <i class="icon-padnote1"></i>留言板管理 </a>
                </li>
                <li class="active">
                    <a href="${ctx}/link/find"> <i class="icon-padnote2"></i>链接管理 </a>
                </li>
                <li>
                    <a href="${ctx}/dev/toLogin"> <i class="icon-interface-windows"></i>登录界面 </a>
                </li>
        ...
        <div class="content-inner">
            ...
            <table class="table table-bordered" style="text-align: center; margin: 0 auto;">
                ...
                <tr>
                    ...
                    <td>
                        <fmt:formatDate value="${obj.value.zxdata}" pattern="yyyy-MM-dd "/>
                    </td>
                    <td>
                        <a href="${ctx}/gszixun/companyLook?id=${obj.value.id}">查看</a>
                        <a href="${ctx}/gszixun/findbyid?id=${obj.value.id}">修改</a>
                        <a href="${ctx}/gszixun/delZX?id=${obj.value.id}" onclick="del()">删除</a>
                    </td>
                </tr>
                </c:forEach>
            </table>
...
<script src="../page/behindPage/js/charts-custom.js"></script>
<!-- Main File-->
